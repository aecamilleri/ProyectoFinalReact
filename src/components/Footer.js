...
function Footer (){
  return (
    <footer className='bg-black'>
        <div className="container m-auto p-4 py-14 dark:bg-gray-800 max-w-screen-xl">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                <Link to={"/"} className='mx-6'>
                    <img src="https://static.wixstatic.com/media/5dcbc4_ad103981fdda4afbbd21c7ffffe933cb.png/v1/fill/w_629,h_107,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/5dcbc4_ad103981fdda4afbbd21c7ffffe933cb.png" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                </Link>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-white">
                    <div>
                        ...
                        <ul className="text-gray-200">
                            <li className="mb-4 ">
                                <a href="https://fakestoreapi.com" className="hover:underline">Flowbite</a>
                            </li>
                            <li>
                                <a href="https://fakestoreapi.com" className="hover:underline">Tailwind CSS</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-200">
                            <li className="mb-4">
                                <a href="https://fakestoreapi.com" className="hover:underline ">Github</a>
                            </li>
                            <li>
                                <a href="https://fakestoreapi.com" className="hover:underline">Discord</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-200">
                            <li className="mb-4">
                                <a href="https://fakestoreapi.com" className="hover:underline">Privacy Policy</a>
                            </li>
                            <li>
                                <a href="https://fakestoreapi.com" className="hover:underline">Terms &amp; Conditions</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between my-6">
                <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2022 <a href="https://fakestoreapi.com" className="hover:underline">BlackMamba™</a>. All Rights Reserved.
                </span>
